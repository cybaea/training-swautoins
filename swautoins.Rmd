...
We process the data to convert the rating factors from integers to categorical values with reasonable lables. We keep all as un-ordered factors to make the interpretation of the models easier.
